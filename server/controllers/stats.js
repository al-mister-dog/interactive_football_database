...
exports.getStats = (req, res, next) => {
  ...
  const queries = {
    teamAge: 'SELECT team, SUM(age) AS "combined age" FROM players GROUP BY team ORDER by SUM(age) DESC',
  ...
  const joinQueries = {
    teamAge: 'SELECT teamName AS team, SUM(Age) AS "combined age" FROM players JOIN teams ON players.teamId = teams.teamId GROUP BY teamName ORDER by SUM(age) DESC',
